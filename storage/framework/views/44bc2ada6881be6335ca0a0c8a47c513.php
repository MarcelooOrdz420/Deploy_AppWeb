...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Pollos y Parrillas El Dorado'); ?></title>
    <style>
        :root {
            --orange: #ff7a1a;
            --orange-soft: #ff9a3d;
                ...
                <div class="topbar-inner">
                    ...
                    <div class="topbar-actions">
                        <div class="session-strip">
                            ...
                            <a class="pill-link cart-link primary-link" href="<?php echo e(route('store.cart')); ?>" aria-label="Ir al carrito">
                        ...
                        <nav class="store-nav">
                            <a href="<?php echo e(route('store.products')); ?>" class="<?php echo e(request()->routeIs('store.products') ? 'active' : ''); ?>">
                                <span class="nav-index"></span> Productos
                            </a>
                            <a href="<?php echo e(route('store.about')); ?>" class="<?php echo e(request()->routeIs('store.about') ? 'active' : ''); ?>">
                                <span class="nav-index"></span> Quienes somos
                            </a>
                            <a href="<?php echo e(route('store.location')); ?>" class="<?php echo e(request()->routeIs('store.location') ? 'active' : ''); ?>">
                                <span class="nav-index"></span> Ubicacion
                            </a>
                            <a href="<?php echo e(route('store.experts')); ?>" class="<?php echo e(request()->routeIs('store.experts') ? 'active' : ''); ?>">
                                <span class="nav-index"></span> Expertos
                            </a>
                            <a href="<?php echo e(route('store.orders')); ?>" class="<?php echo e(request()->routeIs('store.orders') ? 'active' : ''); ?>">
...
<script>
(() => {
    const apiBase = <?php echo json_encode(config('app.api_base_url'), 15, 512) ?>;
...
<script>
(() => {
    const key = <?php echo json_encode(config('broadcasting.connections.pusher.key'), 15, 512) ?>;
    const cluster = <?php echo json_encode(config('broadcasting.connections.pusher.options.cluster'), 15, 512) ?>;
...
<?php /**PATH /home/bcdroovr/public_html/pollos.saborcentral.com/resources/views/store/layout.blade.php ENDPATH**/ ?>
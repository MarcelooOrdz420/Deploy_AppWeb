                ...
                <form id="orderForm" class="checkout-form">
                    ...
                    <section class="surface form-stage payment-stage">
                        ...
                        <label id="payOptions" class="field-card payment-method-field">
                            ...
                            <span class="field-help">Paga con tarjeta, Yape seguro mediante Izipay o al recibir tu pedido.</span>
                        </label>
...
function updateHeroStatus(cart){heroStatus.textContent=!cart.length?'Carrito vacio':paymentMethod()==='yape'?'Listo para pagar con Yape':'Listo para confirmar'}
...
orderForm.addEventListener('submit', async e => {
    ...
    try {
        ...
        if (['izipay', 'yape'].includes(storedPaymentMethod)) {
